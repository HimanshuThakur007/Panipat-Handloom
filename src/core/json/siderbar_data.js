...
export const SidebarData = [
          
    {
        ...
        submenuHdr: "Main",
        submenuItems: [
          { label: "Home", link: "/", icon:<Icon.Grid  />,showSubRoute: false,submenu: false },
        ]
    // {
    //     label: "Main",
    //     submenuOpen: true,
    ...
    //       },
      ...
      },
      {
        ...
        submenuItems: [
          { label: "Design", link: "/product-list", icon:<Icon.Box />,showSubRoute: false,submenu: false },
          ...
          { label: "Sagment", link: "/category-list", icon:  <Icon.Codepen />,showSubRoute: false,submenu: false },
          { label: "Product Type", link: "/inventory-list/1", icon:  <Icon.Bookmark />,showSubRoute: false,submenu: false },
          { label: "Catalogue Name", link: "/sub-categories", icon:  <Icon.Speaker  />,showSubRoute: false,submenu: false },
          ...
          { label: "Tax Type", link: "/inventory-list/2", icon:   <Icon.Maximize  />,showSubRoute: false,submenu: false },
        
          // { label: "Store", link: "/inventory-list/3", icon:  <Icon.Codepen />,showSubRoute: false,submenu: false },
          // { label: "WareHouse", link: "/inventory-list/4", icon:  <Icon.Codepen />,showSubRoute: false,submenu: false },
      ...
      //   submenuItems: [
      //     { label: "Lead List", link: "/lead-list", icon:<Icon.Box />,showSubRoute: false,submenu: false },
      ...
      //     { label: "Physical Stock", link: "/stock-adjustment/1", icon:  <Icon.Clipboard />,showSubRoute: false,submenu: false },
      //     { label: "Super Stockist", link: "/stock/202", icon:  <Icon.Clipboard />,showSubRoute: false,submenu: false },
      //     { label: "Distributer", link: "/stock/203", icon:  <Icon.Clipboard />,showSubRoute: false,submenu: false },
      //     { label: "Retailer", link: "/stock/204", icon:  <Icon.Clipboard />,showSubRoute: false,submenu: false },
      //     // { label: "Stock Transfer", link: "/stock-transfer", icon:  <Icon.Truck />,showSubRoute: false,submenu: false }
      //     { label: "Stock Jenral", link: "/stock-adjustment/2", icon:  <Icon.Truck />,showSubRoute: false,submenu: false }
      //   ]
      // },
      {
        label: "Transactions",
        ...
        submenuItems: [
          ...
          // { label: "Create Enquiry", link: "/add-enquiry", icon: <Icon.PlusSquare />,showSubRoute: false,submenu: false },     
          // { label: "Assign To", link: "/assignto_person_list", icon: <Icon.FileMinus />,showSubRoute: false,submenu: false },
          { label: "Manage Lead", link: "#", icon: <Icon.Clock />,showSubRoute: false, submenu: true,
          
                 submenuItems: [
                   { label: "Enquiry", link: "/enquiry-list" },
                   { label: "Source", link: "/inventory-list/5" },
                   { label: "Purpose", link: "/inventory-list/6" },
                   { label: "Assign Lead", link: "/assignto_person_list/1" },
                  //  { label: "Approval", link: "/assignto_person_list/1" },
                  //  { label: "Assign (Sampling)", link: "/assignto_person_list/2" },
                 ]
               },     
          { label: "Sampling", link: "#", icon: <Icon.Clock />,showSubRoute: false, submenu: true,
          
                 submenuItems: [
                  //  { label: "Assign", link: "/assignto_person_list/1" },
                  { label: "New", link: "/samplinglist/1" },
                  { label: "Edit", link: "/samplinglist/2" },
                  { label: "Approval", link: "/measurment_assign/1" },
                  { label: "Assign (Mesurment)", link: "/measurment_assign/2" },
                 ]
               },     
          { label: "Measurment", link: "#", icon: <Icon.MessageSquare />,showSubRoute: false, submenu: true,
          
                 submenuItems: [
                   
                   { label: "New", link: "/measurmentlist/1" },
                   { label: "Edit", link: "/measurmentlist/2" },
                 ]
               },     
        ]
      },
      {
        ...
        submenuItems: [
          ...
          { label: "Quotation", link: "/list/1", icon:  <Icon.Save />,showSubRoute: false,submenu: false },
          ...
          // { label: "Quotation", link: "/list/1", icon: <Icon.Copy />,showSubRoute: false,submenu: false },
          // { label: "Invoices", link: "/invoice-report", icon:  <Icon.FileText />,showSubRoute: false,submenu: false },
          { label: "Invoices", link: "/list/4", icon:  <Icon.FileText />,showSubRoute: false,submenu: false },
          { label: "Catalogue", link: "/pos", icon:  <Icon.HardDrive />,showSubRoute: false,submenu: false }
        ]
      },
      ...
      // },
      {
        ...
        submenuItems: [
          ...
          { label: "Order", link: "/list/2", icon:  <Icon.FileMinus />,showSubRoute: false ,submenu: false},
          { label: "Invoice", link: "/list/3", icon:  <Icon.RefreshCw />,showSubRoute: false ,submenu: false},
    ...
    //         icon: <Icon.FileText />,
    //         submenuItems: [
    //           {label: "Expenses", link: "/report/4",showSubRoute: false},
    //           {label: "Payment", link: "/report/5",showSubRoute: false},
    //           {label: "Delete Expenses", link: "/report/6",showSubRoute: false},
    //           {label: "Delete Payment", link: "/report/7",showSubRoute: false},
    ...
    //   },

      {
        ...
        submenuItems: [
          { label: "Customers", link: "/customers&supplier/1", icon:<Icon.User />,showSubRoute: false,submenu: false },
          { label: "Supplier", link: "/customers&supplier/2", icon:   <Icon.User />,showSubRoute: false,submenu: false },
      ...
      //   submenuHdr: "HRM",
      //   submenuItems: [
      //     { label: "Leave Reports", link: "/report/1", icon:  <Icon.Calendar />,showSubRoute: false},
      //     { label: "Leave Balance", link: "/report/2", icon:  <Icon.Calendar />,showSubRoute: false },
      //     { label: "Leave Calander", link: "/report/3", icon:  <Icon.Calendar />,showSubRoute: false },
      ...
      // },
      {
        ...
        submenuItems: [
          ...
          { label: "PO Details", link: "/report/podetails", icon:  <Icon.TrendingDown />,showSubRoute: false },
          { label: "Pending PO", link: "/report/pendingpo", icon:  <Icon.FileText />,showSubRoute: false },
          { label: "Quotation", link: "/report/quotation", icon:  <Icon.BarChart />,showSubRoute: false },
          { label: "Pending Quotation", link: "/report/pendingquotation", icon:  <Icon.PieChart />,showSubRoute: false },
          { label: "Purchase Invoice", link: "/report/purchaseinvoice", icon:  <Icon.File />,showSubRoute: false },
          { label: "Party Wise PI", link: "/report/partywisepi", icon:  <Icon.Database />,showSubRoute: false },
          { label: "Sale Invoice", link: "/report/saleinvoice", icon:  <Icon.BarChart2 />,showSubRoute: false },
          { label: "Party Wise SI", link: "/report/partywisesi", icon:  <Icon.UserCheck />,showSubRoute: false },
          { label: "Stock Details", link: "/report/stockdetails", icon:  <Icon.File />,showSubRoute: false },
          { label: "Stock Balance", link: "/report/stockbalance", icon:  <Icon.Inbox />,showSubRoute: false },
...

      {
        ...
        submenuItems: [
          ...
          submenuItems: [
            ...
            // { label: "Customer Mapping", link: "/customer-mapping" },
        ...
        submenuItems: [
            ...
            { label: "Additional field", link: "/additional-fields",showSubRoute: false },
          ...
          // submenuItems: [
          //   { label: "Price list", link: "/pricelist",showSubRoute: false },
