...
export const set_customer_list = (payload) => ({
  type: "Customer_list",
  payload,
});

export const set_form_data = (quotationData, billsundryData, formData) => ({
  type: "SET_FORM_DATA",
  payload: {
    quotationData,
    billsundryData,
...
export const set_financialTable_data = (data) => ({
  type: "Financial_Table",
  payload:data,
});

export const resetFinancialTableData = () => ({
  type: "RESET_FinancialTable_DATA",
});
// export const set_quotationform_data = (data) => ({
//   type: "Quotation_Data",
//   payload:data,
// });

// export const resetQuotationData = () => ({
//   type: "RESET_QUOTATION_DATA",
// });
export const set_billsundry_data = (data) => ({
  type: "billsundry_data",
  payload:data,
});

export const resetBillSundryData = () => ({
  type: "RESET__Billsundry_Data",
});
