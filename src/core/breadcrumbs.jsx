...
const Breadcrumbs = (props) => {
  ...
  if (
    ...
    location.pathname === "/report/podetails"||
    location.pathname === "/report/pendingpo"
  ) {
    addButton = (
      <div className="page-header">
        <div className="add-item d-flex">
        ...
        <ul className="table-top-head">
          ...
          <li>
            <OverlayTrigger placement="top" overlay={renderExcelTooltip}>
              <Link data-bs-toggle="tooltip" data-bs-placement="top" onClick={props.onClick}>
                <ImageWithBasePath src="assets/img/icons/excel.svg" alt="img" />
              </Link>
            </OverlayTrigger>
          </li>
    ...
    location.pathname == "/customers&supplier/1" ||
    location.pathname == "/customers&supplier/2" ||
    location.pathname == "/warehouse" ||
    location.pathname == "/store-list" ||
    location.pathname == "/suppliers" ||
    location.pathname == "/manage-stocks" ||
    location.pathname == "/stock-adjustment/1"||
    location.pathname == "/stock-adjustment/2"
  ) {
    addButton = (
      <div className="page-header">
        <div className="add-item d-flex">
