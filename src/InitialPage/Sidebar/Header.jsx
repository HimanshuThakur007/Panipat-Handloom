      ...
      <div className="header">
        ...
        >
          <Link to="/dashboard" className="logo logo-normal">
            <ImageWithBasePath src="assets/img/panipatlogo.png" alt="img" />
          </Link>
          <Link to="/dashboard" className="logo logo-white">
            <ImageWithBasePath src="assets/img/panipatlogo.png" alt="img" />
          </Link>
          <Link to="/dashboard" className="logo-small">
            <ImageWithBasePath src="assets/img/es-mini-logo.png" alt="img" />
          </Link>
          <a
            id="toggle_btn"
            // to="#"
          ...
          <li className="nav-item dropdown has-arrow main-drop">
            ...
            <div className="dropdown-menu menu-drop-user">
              <div className="profilename">
                ...
                <hr className="m-0" />
                <Link className="dropdown-item logout pb-0" to="/signin"  onClick={() => {
        ...
        <div className="dropdown mobile-user-menu">
          ...
          <div className="dropdown-menu dropdown-menu-right">
            ...
            <Link className="dropdown-item" to="signin" onClick={()=>{sessionStorage.clear()}}>
              Logout
            </Link>
          </div>
        </div>
