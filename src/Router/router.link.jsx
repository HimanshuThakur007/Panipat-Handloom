...
import LeadListComp from "../feature-module/LeadList/LeadListComp";
import WhatsAppConfigPage from "../feature-module/settings/generalsettings/whatsappconfigpage";
import EmailConfigPage from "../feature-module/settings/generalsettings/emailconfigpage";
import AddProductPage from "../feature-module/inventory/addproductpage";
import AdditionalFields from "../feature-module/settings/appsetting/additionalfield";
import OrderList from "../feature-module/sales/orderlist";
import CustomerReview from "../feature-module/people/customerreview";
import InventoryList from "../feature-module/inventory/inventorylist";
import BankSettingGrid from "../feature-module/settings/financialsettings/banksettinggrid";
import PaymentSucess from "../feature-module/settings/financialsettings/paymentsucess";
import CustomerMappingPage from "../feature-module/settings/generalsettings/customermappingpage";
import StockPage from "../feature-module/stock/StockPage";
import SubcategoryPage from "../feature-module/sales/SubcategoryPage";
import Productpage from "../feature-module/sales/productpage";
import ProductDetails from "../feature-module/sales/productdetail";
import SearchResults from "../feature-module/sales/searchresults";
import EnquirylistPage from "../feature-module/transactions/enquiry/enquirylist";
import AddEnquiry from "../feature-module/transactions/enquiry/addenquiry";
import SalespersonList from "../feature-module/transactions/assigntosalesperson/salespersonlist";
import Samplinglist from "../feature-module/transactions/sampling/samplinglist";
import SamplingPage from "../feature-module/transactions/sampling/samplingpage";
import AssignToList from "../feature-module/transactions/measurment/assigntolist";
import Measurmentlist from "../feature-module/transactions/measurment/measurmentlist";
import MeasurmentPage from "../feature-module/transactions/measurment/measurmentpage";
// import Quotationlist from "../feature-module/transactions/sales&purchase/financiallist";
// import QuotationPage from "../feature-module/transactions/sales&purchase/financialpage";
import Financiallist from "../feature-module/transactions/sales&purchase/financiallist";
import FinancialPage from "../feature-module/transactions/sales&purchase/financialpage";
import ReportComp from "../feature-module/Reports/ReportComp";
...
export const publicRoutes = [
  ...
  {
    id: 126,
    path: routes.LeadListComp,
    name: "LeadListComp",
    element: <LeadListComp/>,
    route: Route,
  },
  {
    id: 127,
    path: routes.whatsappconfigpage,
    name: "whatsappconfigpage",
    element: <WhatsAppConfigPage/>,
    route: Route,
  },
  {
    id: 128,
    path: routes.emailconfigpage,
  ...
  {
    id: 142,
    path: routes.customermappingpage,
    name: "customermappingpage",
    element: <CustomerMappingPage />,
    route: Route,
  },
  ...
  {
    id: 1456,
    path: routes.reportscomp,
    name: "reportscomp",
    element: <ReportComp />,
  },
  {
    id: 1458,
    path: routes.enquirylistpage,
    name: "enquirylistpage",
    element: <EnquirylistPage />,
  },
  {
    id: 1459,
    path: routes.addenquiry,
    name: "addenquiry",
    element: <AddEnquiry />,
  },
  {
    id: 1460,
    path: routes.salespersonlist,
    name: "salespersonlist",
    element: <SalespersonList />,
  },
  {
    id: 1461,
    path: routes.samplinglist,
    name: "samplinglist",
    element: <Samplinglist />,
  },
  {
    id: 1462,
    path: routes.samplingpage,
    name: "samplingpage",
    element: <SamplingPage />,
  },
  {
    id: 1463,
    path: routes.measurmentassignlist,
    name: "measurmentassignlist",
    element: <AssignToList />,
  },
  {
    id: 1464,
    path: routes.measurmentlist,
    name: "measurmentlist",
    element: <Measurmentlist />,
  },
  {
    id: 1465,
    path: routes.measurmentpage,
    name: "measurmentpage",
    element: <MeasurmentPage />,
  },
  {
    id: 1466,
    path: routes.financialpage,
    name: "financialpage",
    element: <FinancialPage />,
  },
  {
    id: 1467,
    path: routes.financiallist,
    name: "financiallist",
