...
export const all_routes = {
  ...
  whatsappconfigpage:"/whatsapp_config",
  emailconfigpage:"/email_config",
  ...
  payslip: "/payslip",
  holidays: "/holidays",
  customers: "/customers&supplier/:id",
  suppliers: "/suppliers",
  storelist: "/store-list",
  managestock: "/manage-stocks",
  stockadjustment: "/stock-adjustment/:id",
  stockpage:'/stock/:id',
  ...
  // ==================================lead===============================================
  LeadListComp: "/lead-list",
  // ====================================Review=============================================
  customerreview:"/customer-review",
  // ArticleTab:''
  // ====================================Review=============================================

  inventorylist:"/inventory-list/:userId",

  paymentsucess:'/payment-sucess',
  ...
  customermappingpage:'/customer-mapping',
  reportscomp:'/report/:id',
  productpage:'productpage/:subcatId',
  productdetail:'productdetail/:prodId',
  searchresult:'search',
  enquirylistpage:'/enquiry-list',
  addenquiry:'/add-enquiry',
  salespersonlist:'/assignto_person_list/:id',
  samplinglist:'/samplinglist/:id',
  samplingpage:'/samplingpage/:id',
  measurmentassignlist:'/measurment_assign/:id',
  measurmentlist:'/measurmentlist/:id',
  measurmentpage:'/measurmentpage',
  financialpage:'/page',
  financiallist:'/list/:id',
  // reportscomp:"/report/:id"
  // supplier:'/supplier',
};
